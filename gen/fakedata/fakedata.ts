...
export const case_4_initial = [
    ...
    { Symbol: 'LU0119099819', MacroAssetClass: 'Funds', AssetClass: 'Fixed Income', AssetType: 'Corporate Bond', Name: 'Amundi Fds Bond Euro Corporate', Mstar_BCH: 'Barclays Euro Agg Corps TR EUR', Mstar_SRRI: 3, WEIGHT: 0.3, SRRI: 0.9, },
    { Symbol: 'LU0281578517', MacroAssetClass: 'Funds', AssetClass: 'Fixed Income', AssetType: 'Government Bond', Name: 'Pioneer Fds Euro Bond', Mstar_BCH: 'Citi EMU GBI EUR', Mstar_SRRI: 3, WEIGHT: 0.3, SRRI: 0.9, },
    { Symbol: 'LU0201576401', MacroAssetClass: 'Funds', AssetClass: 'Fixed Income', AssetType: 'Inflation Linked', Name: 'Amundi Fds Bond Euro Inflation', Mstar_BCH: 'Barclays Euro Infln Lkd TR EUR', Mstar_SRRI: 3, WEIGHT: 0.05, SRRI: 0.15, },
    { Symbol: 'LU0281579598', MacroAssetClass: 'Funds', AssetClass: 'Fixed Income', AssetType: 'High Yield', Name: 'Pioneer Fds Euro High Yield', Mstar_BCH: 'BofAML European Ccy HY Constnd TR HEUR', Mstar_SRRI: 3, WEIGHT: 0.05, SRRI: 0.15, },
    { Symbol: 'LU0568620560', MacroAssetClass: 'Funds', AssetClass: 'Money Market', AssetType: 'Money Market', Name: 'Amundi Fds Cash EUR', Mstar_BCH: '', Mstar_SRRI: 1, WEIGHT: 0.1, SRRI: 0.1, },
]
